...
var PurchaseArray=[];
PurchaseArray.push( new Purchase("Xiaomi",7.23,3));
PurchaseArray.push( new Purchase("Apple",2.41,10));
PurchaseArray.push( new Purchase("Oppo",2.5,3));
PurchaseArray.push( new PurchasePriceDiscont("HTC",2.59,2,0.5));
PurchaseArray.push( new PurchasePriceDiscont("Huawei",80.9,1,0.5));
PurchaseArray.push( new PurchasePriceDiscont("LG",2.15,2,0.5));
PurchaseArray.push( new PurchasePersentDiskont("Lenovo",2.69,15,12));
PurchaseArray.push( new PurchasePersentDiskont("Fly",3.72,3,15));
PurchaseArray.push( new PurchasePersentDiskont("Xiaomi",2.50,4,20));
